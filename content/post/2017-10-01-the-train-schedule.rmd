...
To make this easier to look at let's filter to just between 6am and noon.

```{r filtered_plot}

plot_df <- td_g %>% filter(
    time >= as.POSIXct('2017-10-02 06:00:00')
    , time <= as.POSIXct('2017-10-02 12:00:00')
  )
...
ggplot(
  ...
  scale_y_continuous(
    labels = c('san_francisco','22nd_street','bayshore','so_san_francisco','san_bruno','millbrae','broadway','burlingame','san_mateo','hayward_park','hillsdale','belmont','san_carlos','redwood_city','atherton','menlo_park','palo_alto','california_ave','san_antonio','mountainview','sunnyvale','lawrence','santaclara','college_park','san_jose','tamien','capitol','blossom_hill','morgan_hill','san_martin','gilroy')
    , breaks = c(-0,-40,-124,-178,-216,-249,-280,-307,-334,-354,-391,-428,-458,-499,-543,-574,-604,-649,-676,-702,-731,-757,-805,-833,-862,-906,-939,-966,-997,-1021,-1053)
    ) +
  scale_color_manual(values=c("#F76F5CFF", "#000004FF"))
